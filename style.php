...
.menu{display:inline-block;text-align:center;border:1px solid #000;margin-bottom:60px;margin-top:20%;}
...
/** Socila icons **/
.single-sc-ic .amp-social{
    padding: 0;
    margin:30px 0px 0px 0px;
}
.single-sc-ic .amp-social li:before{
    background:#e4dedec7;
    width: 20px;
    height: 20px;
    color:#333;
